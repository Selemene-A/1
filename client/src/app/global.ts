export const GlobalPaths = Object.freeze({
    ...
    MEN_PATH :     'http://localhost:8000/api/products',
    ELEC_PATH :    'https://ibnmhmd.github.io/Shopping-Cart/assets/data/electronics.json',
    USERS_PATH :   'https://ibnmhmd.github.io/Shopping-Cart/assets/data/users_data.json',
    NO_DATA_PATH : 'https://ibnmhmd.github.io/Shopping-Cart/assets/data/no_data.json',
